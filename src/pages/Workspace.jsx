...
function PledgeWizard({ saved, initialOrgan, draft, user, onDiscard, onDone }) {
  ...
  return <Wizard steps={steps} busy={action.busy} error={action.error} submitLabel="Save pledge" draft={draft} onDiscard={onDiscard}
    aside={<><PrivateHint>Hospitals see an anonymous donor number with your health answers. Your contact details are shared only if you accept a match.</PrivateHint><p>A living donor can give a kidney, or part of a liver, lung, pancreas, or intestine. Heart, eyes, and heart valves are pledged for after death.</p></>}
